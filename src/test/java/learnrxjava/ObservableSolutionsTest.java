...
import org.na.rxjavainpractice.learnrxjava.ObservableExercises;
import org.na.rxjavainpractice.learnrxjava.ObservableSolutions;
...
//        getImpl().exerciseHello().subscribeWith(ts);
...
//                );
//
//        Map<Integer, Integer> map = getImpl().exerciseFlatMap(movies).toMap(i -> i).blockingGet();
...
//                );
//
//        Map<Integer, JSON> map = getImpl().exerciseMovie(movies).toMap(i -> (int) i.get("id")).blockingGet();
...
//        TestSubscriber<String> ts = new TestSubscriber<>();
//        getImpl().exerciseZip(just("one", "two", "blue", "red"), just("fish", "fish", "fish", "fish")).<?>subscribeWith(ts);
//        ts.awaitTerminalEvent();
//        ts.assertNoErrors();
...
//        TestSubscriber<String> ts = new TestSubscriber<>();
//        getImpl().handleError(error(new RuntimeException("failure"))).subscribeWith(ts);
//        ts.awaitTerminalEvent();
//        ts.assertNoErrors();
...
//        ts.awaitTerminalEvent();
//        ts.assertNoErrors();
//        ts.onNext();assertReceivedOnNext(Arrays.asList("success!"));
//    }
//
//    /**
